...
import com.agg.tron.game.Game;
import com.agg.tron.game.Player;
import com.agg.tron.game.PlayerFactory;
...
public class WebsocketHandler {
    ...
    public void onMessage(String message, Session session) throws IOException, EncodeException {
        ...
        if (json.containsKey("message")) {
            ...
            Player p = PlayerFactory.initNextPlayer(game, session, userSession.getDisplayName());
